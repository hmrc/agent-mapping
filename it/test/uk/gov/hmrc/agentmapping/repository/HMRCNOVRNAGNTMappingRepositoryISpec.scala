...
with DefaultPlayMongoRepositorySupport[AgentReferenceMapping]:
  ...
  override val repository: MappingRepository = new HMRCNOVRNAGNTMappingRepository(mongoComponent)(using global, crypto)
...
end HMRCNOVRNAGNTMappingRepositoryISpec
